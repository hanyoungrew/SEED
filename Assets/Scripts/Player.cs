...
public class Player : MonoBehaviour
{
    ...
    Color pcolor;
    Color heal_color = Color.green;

    Color damage_color = Color.black;

    Color fire_color = Color.red;

    Color play_card_color = Color.magenta;
    #endregion
    ...
    void Awake()
    {
        ...
        if (leftPlayer){
            ...
            pcolor =  spriteRenderer.color;
        } else {
            spriteRenderer.sprite = GetComponent<FlowerSprite>().flower;
    ...
    void Update()
    {
        ...
        //im doing this in game manager now
        /*if (card_timer > 0){
    ...
    public void loadPlayer(){
        ...
        speedStat = stats.speedStat * 0.8f;
        ...
        if (card_holster[card_index].Item2 == 0) {
            if (!dead && control.roundSafe) {
                ...
                if (sunlightTokenss >= current_card.sunlightCost){
                    if (current_card.flavorText == "Heals 2 Health"){
                    ...
                    card_holster[card_index] = (current_card, current_card.cooldownTime);
                    //Debug.Log(card_timer);s
                }
